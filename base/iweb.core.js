class iwebApp {
    ...
    copyright() {
        ...
        const text = [
            'iweb core javaScript class - easily build web applications with the most commonly used features already included.',
            'Copyright: ' + yearText+ ' ' + author,
            'License: Personal/educational use only. Modifications and commercial use require permission.',
            'Learn more: https://github.com/728rabbit/iweb-core-javascript-class'
        ];
